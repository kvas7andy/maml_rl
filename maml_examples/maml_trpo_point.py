...
fast_learning_rates = [0.5] #[0.1, 0.5] # ORIGINAL: 0.1
baselines = ['linear']
fast_batch_size = 20  # 10 works for [0.1, 0.2], 20 doesn't improve much for [0,0.2]
meta_batch_size_s = [40] #[20, 40] # ORIGINAL: 20  # 10 also works, but much less stable, 20 is fairly stable, 40 is more stable
max_path_length = 100
num_grad_updates = 1
meta_step_size_s = [0.01] #[0.01, 0.005]# ORIGINAL: 0.01

use_maml = True

for fast_learning_rate in fast_learning_rates:
    #for learning_rate in learning_rates:
    for meta_batch_size in meta_batch_size_s:
        for meta_step_size in meta_step_size_s:
            #if fast_learning_rate == 0.5 and meta_batch_size == 40 and meta_step_size == 0.01:
            #    continue
